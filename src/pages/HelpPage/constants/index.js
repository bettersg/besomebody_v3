...
export const HELP_DETAILS = [
    {
        ...
        questions: [
            {
                question: "I want to play as the other characters! How do I access them?", 
                answer: `After creating a new account or logging in, all users are automatically directed to the “Character Menu”, and all available characters are accessible from there. 
                <br/><br/>
            ...
            }, 
            {
                ...
                answer: `Click the menu icon on the top right of the screen, and the “Chapter Menu” will be accessible from the sidebar.
                <br/><br/>
            ...
            }, 
            {
                ...
                answer: `The ending of each chapter is dependent on the choices you made within each playthrough. Explore different choices to unlock new endings!
                <br/><br/>
            ...
            }, 
            {
                ...
                answer: `To Be You was conceived to help dismantle stereotypes, reduce prejudice, and ultimately foster greater empathy and inclusiveness among Singaporeans. By asking questions, we hope to encourage users to reflect on their experiences, and share their thoughts on the dilemmas that the characters are facing.`, 
                panel: "panel1e", 
        ...
        questions: [
            {
                ...
                answer: `Please take a screenshot of the error in the game or where you have a concern, and email <a href="mailto:tobeyou@better.sg">tobeyou@better.sg</a>`, 
                panel: "panel2a", 
    ...
    },
    {
        ...
        questions: [
            ...
            }, 
            {
                ...
                answer: `You can rebuild your profile in the “Account Menu”. Click the menu icon on the top right of the screen, and then click the option to Rebuild Your Profile.`, 
                panel: "panel3b", 
