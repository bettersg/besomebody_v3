  ...
  return (
    <div>
        ...
        <Box className={classes.paragraphWrapper}  height="100%">
          { step && (
            <Fade in={step.text} timeout={200}>
              <div className="Notification__text">
                ...
                {step.tags[0] === 'call' ?   
                  <Box>                   
                   <Typography variant="h5"> {step.text.toUpperCase()} </Typography>
                  </Box>
                  : null}
              </div>
            </Fade>
          ...
          {choices.length > 0 ? 
            <div className="Notification__choicesWrapper" >            
              {choices.map((choice) => (
                ...
                <Box
                    ...
                    // my={1}
                    className="Notification__choicesWrapper__choices"
